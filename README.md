...
- **Self-hosting or cloud version:** enables you to host code completion and chat models yourself. The Refact self-hosting server supports many recent models, offers efficient inference, and facilitates fine-tuning.
...
## Refact For Enterprise

Are you part of an Enterprise and want to **boost developers' efficiency by 45%**? The Refact Enterprise plan offers:
- **Knows Your Code:** Refact focuses on automated customization for internal codebases and improving over time.
- **Ultimate Security:** Deploy Refact on-premise: on your own servers or private cloud. Your data never leaves your control. Telemetry from the plugins goes to your server and nowhere else. You can verify what the code does, it's open source.
...
- **User Statistics:** Keep track of how much code Refact helps to write for each team member. Measure productivity gains with real numbers.
